...
PHOTOS = [
    ...
    ("009 AP Garden Beds at Entrance.jpeg",                "garden-beds-entrance", 0.50),
    ...
    ("039 AP Children_s Pots on Stump.png",                "childrens-pots",       0.45),
    ("024 AP Terracotta Pots on Shelf.png",                "terracotta-shelf",     0.45),
    ...
    ("038 AP Compost Bin.png",                             "compost-bin",          0.45),
    ("045 AP Stump with Flower.png",                       "stump-flower",         0.45),
    ("002 AP Adult Tools Hanging Walkway.png",             "tools-walkway",        0.45),
